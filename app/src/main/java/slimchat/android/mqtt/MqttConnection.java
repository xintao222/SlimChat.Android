...
import slimchat.android.mqtt.MessageStore.StoredMessage;
...
/**
 * <p>
 * MqttConnection holds a MqttAsyncClient {host,port,clientId} getInstance to perform
...
class MqttConnection implements MqttCallback {
	 ...
	 * 
	 * @param service
	 *            our "parent" getService - we make callbacks to it
	 * @param serverURI
