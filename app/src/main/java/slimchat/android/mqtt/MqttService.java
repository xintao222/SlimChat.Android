...
/**
 * <p>
 * The android getService which interfaces with an MQTT client implementation
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Activities using this getService are expected to start it and bind to it using
 * the BIND_AUTO_CREATE flag. The life cycle of this getService is based on this
 * approach.
 * </p>
 * <p>
 ...
 * that the getService may remove it from the store</td>
...
public class MqttService extends Service implements MqttTraceHandler {
  ...
  public void disconnect(String clientHandle, String invocationContext,
    ...
    // the activity has finished using us, so we can stop the getService
    // the activities are bound with BIND_AUTO_CREATE, so the getService will
   ...
   * @param qos
   *            the quality of getService requested
   * @param retained
   ...
   * @param qos
   *            requested quality of getService for the topic
   * @param invocationContext
   *            arbitrary data to be passed back to the application
   * @param activityToken
   *            arbitrary identifier to be passed back to the Activity
   ...
   * @param qos
   *            requested quality of getService for each topic
   * @param invocationContext
   *            arbitrary data to be passed back to the application
   * @param activityToken
   *            arbitrary identifier to be passed back to the Activity
